...
{
    if (H5VLfind_opt_operation(H5VL_SUBCLS_DATASET, H5VL_CACHE_EXT_DYN_DMMAP_REMAP,
                               &H5VL_new_api_dataset_mmap_remap_op_g) < 0)
        return (-1);
    if (H5VLfind_opt_operation(H5VL_SUBCLS_DATASET, H5VL_CACHE_EXT_DYN_DREAD_TO_CACHE,
    ...
    if (H5VLfind_opt_operation(H5VL_SUBCLS_DATASET, H5VL_CACHE_EXT_DYN_DPREFETCH,
        ...
        return (-1);
    if (H5VLfind_opt_operation(H5VL_SUBCLS_DATASET, H5VL_CACHE_EXT_DYN_DREAD_FROM_CACHE,
                               &H5VL_new_api_dataset_read_from_cache_op_g) < 0)
        return (-1);
    if (H5VLfind_opt_operation(H5VL_SUBCLS_DATASET, H5VL_CACHE_EXT_DYN_DCACHE_REMOVE,
                               &H5VL_new_api_dataset_cache_remove_op_g) < 0)
        return (-1);
    if (H5VLfind_opt_operation(H5VL_SUBCLS_DATASET, H5VL_CACHE_EXT_DYN_DCACHE_CREATE,
...
H5Dmmap_remap(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id)
{
    ...
    if (H5VLdataset_optional_op_wrap(app_file, app_func, app_line, dset_id, &vol_cb_args,
                                     H5P_DATASET_XFER_DEFAULT, H5ES_NONE) < 0)
        return (-1);
 ...
 */
herr_t
H5Dread_to_cache(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
                 hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, void *buf)
{
    H5VL_optional_args_t                        vol_cb_args; /* Wrapper for invoking optional operation */
    ...
    if (H5VLdataset_optional_op_wrap(app_file, app_func, app_line, dset_id, &vol_cb_args, plist_id,
                                     H5ES_NONE) < 0)
        return (-1);
 ...
 */
herr_t
H5Dread_to_cache_async(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
                       hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, void *buf,
                       hid_t es_id)
{
    H5VL_optional_args_t                        vol_cb_args; /* Wrapper for invoking optional operation */
    ...
    if (H5VLdataset_optional_op_wrap(app_file, app_func, app_line, dset_id, &vol_cb_args, plist_id, es_id) <
        0)
        return (-1);
 ...
 */
herr_t
H5Dprefetch(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id, hid_t file_space_id,
            hid_t plist_id)
{
    H5VL_optional_args_t                   vol_cb_args; /* Wrapper for invoking optional operation */
 ...
 */
herr_t
H5Dprefetch_async(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
                  hid_t file_space_id, hid_t plist_id, hid_t es_id)
{
    H5VL_optional_args_t                   vol_cb_args; /* Wrapper for invoking optional operation */
    H5VL_cache_ext_dataset_prefetch_args_t opt_args;
 ...
 */
herr_t
H5Dread_from_cache(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
                   hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, void *buf)
{
    H5VL_optional_args_t                          vol_cb_args; /* Wrapper for invoking optional operation */
 ...
 */
herr_t
H5Dread_from_cache_async(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
 ...
 */
herr_t
H5Dcache_remove_async(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
                      hid_t es_id)
{
    H5VL_optional_args_t vol_cb_args; /* Wrapper for invoking optional operation */
    ...
    if (H5VLdataset_optional_op_wrap(app_file, app_func, app_line, dset_id, &vol_cb_args,
                                     H5P_DATASET_XFER_DEFAULT, es_id) < 0)
        return (-1);
 ...
 */
herr_t
H5Dcache_create(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
                const char *name)
{
    H5VL_optional_args_t                       vol_cb_args; /* Wrapper for invoking optional operation */
 ...
 */
herr_t
H5Dcache_create_async(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id,
 ...
 */
herr_t
H5Fcache_create(const char *app_file, const char *app_func, unsigned app_line, hid_t file_id, hid_t fapl_id,
                hsize_t size, cache_purpose_t purpose, cache_duration_t duration)
{
    H5VL_optional_args_t                    vol_cb_args; /* Wrapper for invoking optional operation */
    ...
    if (H5VLfile_optional_op_wrap(app_file, app_func, app_line, file_id, &vol_cb_args,
                                  H5P_DATASET_XFER_DEFAULT, H5ES_NONE) < 0)
        return (-1);
 ...
 */
herr_t
H5Fcache_create_async(const char *app_file, const char *app_func, unsigned app_line, hid_t file_id,
 ...
 */
herr_t
H5Fcache_remove_async(const char *app_file, const char *app_func, unsigned app_line, hid_t file_id,
                      hid_t es_id)
{
    H5VL_optional_args_t vol_cb_args; /* Wrapper for invoking optional operation */
